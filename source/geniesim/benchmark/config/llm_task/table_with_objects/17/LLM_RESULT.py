...
def table_with_objects() -> Shape:
    ...
    table_top_z = table_info["max"][2]
    table_center_x = table_info["center"][0]
    table_center_y = table_info["center"][1]

    # Object list provided by user
    object_list = ["apple", "blocks", "cola", "facecleaner", "sprite","table_001"]
